...
function RightDM() {
  return (
    <div className="ml-[27.5%] h-screen flex flex-col justify-center items-center ">
      ...
      <button className="cursor-pointer mt-4 bg-[#0095f6] text-sm font-semibold px-2.5 py-1.5 rounded-md">
        Send message
      </button>
    </div>
  );
